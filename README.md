<a href="https://joinstudenthub.com">
  <picture>
    ...
    <img src="assets/boards/hero-light.png" width="100%" alt="StudentHub: everything uni, in one app. Neptun grades, a student marketplace, rooms, weekly akciók and events for university students in Hungary." />
  </picture>
</a>

<p align="center">
  <a href="https://apps.apple.com/app/studenthub-uni-life/id6799090991"><img src="assets/badges/app-store.svg" height="44" align="middle" alt="Download StudentHub on the App Store" /></a>
  &nbsp;
  <a href="https://play.google.com/store/apps/details?id=dev.studenthub.app"><img src="assets/badges/google-play.png" height="64" align="middle" alt="Get StudentHub on Google Play" /></a>
</p>
...
<table>
  <tr>
    <td width="50%" valign="top"><img src="assets/icons/grades.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Neptun sync and GPA</b><br /><sub>Grades, credits, weighted average and a what-if forecast.</sub></td>
    <td width="50%" valign="top"><img src="assets/icons/schedule.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Timetable and reminders</b><br /><sub>Your week from Neptun, with offline class reminders.</sub></td>
  </tr>
  <tr>
    <td valign="top"><img src="assets/icons/marketplace.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Marketplace</b><br /><sub>Buy, sell and give away between verified students.</sub></td>
    <td valign="top"><img src="assets/icons/rooms.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Rooms</b><br /><sub>Real monthly price, and whether bills are included.</sub></td>
  </tr>
  <tr>
    <td valign="top"><img src="assets/icons/roommates.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Roommate finder</b><br /><sub>Match score, budget and district up front.</sub></td>
    <td valign="top"><img src="assets/icons/deals.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Weekly akciók</b><br /><sub>Grocery deals from five chains, every week.</sub></td>
  </tr>
  <tr>
    <td valign="top"><img src="assets/icons/events.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Events</b><br /><sub>Parties, faculty nights, career fairs and culture.</sub></td>
    <td valign="top"><img src="assets/icons/chat.svg" width="20" align="left" alt="" />&nbsp;&nbsp;<b>Chat</b><br /><sub>Real-time messages between verified students.</sub></td>
  </tr>
</table>

### Neptun grades and a GPA calculator

<p><img src="assets/boards/gpa.png" width="100%" alt="StudentHub GPA tracker: Neptun GPA, credit index and linked Neptun, Canvas and Moodle accounts" /></p>
...
<p><img src="assets/boards/market.png" width="100%" alt="StudentHub marketplace with an e-bike, AirPods and textbooks posted by students in Budapest" /></p>
...
<p><img src="assets/boards/city.png" width="100%" alt="StudentHub rooms, roommate finder and weekly grocery deals in Budapest" /></p>
...
<p><img src="assets/boards/events.png" width="100%" alt="StudentHub events feed with social, academic, career and cultural events in Budapest" /></p>
...
<details>
<summary><b>Is my Neptun login safe?</b></summary>
<br />
...
<details>
<summary><b>What does StudentHub cost?</b></summary>
<br />
...
<details>
<summary><b>I'm not in Budapest. Is it still useful?</b></summary>
<br />
...
<details>
<summary><b>Is this an official Neptun app?</b></summary>
<br />
...
<details>
<summary><b>I'm an international student. Is the app in English?</b></summary>
<br />
...
```mermaid
%%{init: {"theme": "base", "themeVariables": {"fontSize": "14px", "primaryColor": "#fdf9f1", "primaryTextColor": "#2b201a", "primaryBorderColor": "#3d777d", "lineColor": "#3d777d", "secondaryColor": "#f3ebdd", "tertiaryColor": "#f3ebdd", "clusterBkg": "#f6efe3", "clusterBorder": "#e5b464", "titleColor": "#2b201a", "edgeLabelBackground": "#fdf9f1"}}}%%
flowchart TB
    subgraph phone["Student's phone"]
        app["StudentHub app<br/>React Native · Expo"]
    end
    neptun["University Neptun portal"]
    admin["Admin panel<br/>React · Vite"]
    subgraph server["Docker Compose · EU server"]
        edge["Caddy<br/>HTTPS reverse proxy"]
        api["ASP.NET Core API<br/>CQRS · SignalR"]
        jobs["Background jobs<br/>Canvas · Moodle · notifications"]
        collector["Data service<br/>Python"]
        db[("PostgreSQL + PostGIS")]
    end
    fcm["Firebase Cloud Messaging"]

    app -. "read-only sign-in, on the phone" .-> neptun
    app -- "REST + SignalR" --> edge
    admin --> edge
    edge --> api
    api --> db
    jobs --> db
    ...
    classDef accent fill:#3d777d,stroke:#3d777d,color:#fdf9f1
    classDef warm fill:#e5b464,stroke:#e5b464,color:#2b201a
    class app,api accent
    class db warm
```
...
<p>
  <img src="https://cdn.simpleicons.org/dotnet/7A8B8C" height="26" alt=".NET" title=".NET" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/postgresql/7A8B8C" height="26" alt="PostgreSQL" title="PostgreSQL" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/react/7A8B8C" height="26" alt="React Native" title="React Native" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/expo/7A8B8C" height="26" alt="Expo" title="Expo" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/typescript/7A8B8C" height="26" alt="TypeScript" title="TypeScript" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/python/7A8B8C" height="26" alt="Python" title="Python" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/docker/7A8B8C" height="26" alt="Docker" title="Docker" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/firebase/7A8B8C" height="26" alt="Firebase" title="Firebase" />&nbsp;&nbsp;
  <img src="https://cdn.simpleicons.org/caddy/7A8B8C" height="26" alt="Caddy" title="Caddy" />
</p>
...
<table>
  <tr>
    ...
    <td align="center" width="200">
      <a href="https://github.com/smile-web-tech"><img src="https://github.com/smile-web-tech.png?size=200" width="88" alt="Ysmayyl Mammetgeldiyev" /></a><br />
      <b>Ysmayyl Mammetgeldiyev</b><br />
      <sub>Co-founder · Full-stack engineer</sub><br />
...
<a href="https://joinstudenthub.com">
  <img src="assets/boards/cta.png" width="100%" alt="Uni is enough work. The app shouldn't be. Free on iPhone and Android at joinstudenthub.com" />
</a>
...
<sub>StudentHub is an independent student project. It is not affiliated with, endorsed by or operated by Neptun, SDA Informatika, Instructure (Canvas), Moodle or any university. App Store is a service mark of Apple Inc. Google Play is a trademark of Google LLC.<br />© 2026 StudentHub. All rights reserved.</sub>
